  ...
  return (
    <div className="flex flex-col w-full">
      <div className="flex xl:w-[97.5vw] xl:-ml-[57.8%] mt-5 justify-center h-[20vh] xl:h-[20vh] items-end bg-black">
        ...
        <h1 className="font-bold xl:text-xl h-14 w-1/3 mb-2 ml-12 xl:ml-40 text-[#DDE1D4] ">
      ...
      <div className="bg-[#ff6347] h-[65vh] mt-5 xl:h-[100vh] w-full ml-0 xl:w-[97.5vw] mb-4 flex flex-col ">
